 ...
 *
 */
public class GetSuppliersAndItemForSuppliersServlet extends HttpServlet {
...
//            
//            ArrayList<RefSupplier> RefSupplierList = new RefSupplierDAO().getSupplier();
//          
//            JSONArray array = new JSONArray(RefSupplierList);
