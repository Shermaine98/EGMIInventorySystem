            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Nawala <span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
                                <li><a href=".jsp">Nawala</a></li>
                                <li><a href=".jsp">Nawala</a></li>
                                <li class="divider"></li>
                                <li><a href=".jsp">Receive</a></li>

                            </ul>
                        </li>
                        <li><a href="">Nawala Si shermaine d2</a></li>
                    </ul>
