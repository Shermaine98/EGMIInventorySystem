                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Procurement<span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
                                <li><a href="EncodeSupplierPurchaseOrder.jsp">Supplier Purchase Order</a></li>
                                <li><a href="ViewSupplierPurchaseOrder.jsp">View Supplier Purchase Order</a></li>
                                <li class="divider"></li>
                                <li><a href="Receiving.jsp">Receive</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Vendor<span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
                                <li><a href="/EGMIInventoryManagementSystem/ViewSuppliersServlet">Suppliers</a></li>
                                <li><a href="/EGMIInventoryManagementSystem/ViewSubcontractorServlet">Subcontractor</a></li>
                            </ul>
                        </li>
