                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Procurement <span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
                                <li><a href="SubcontractorPurchaseOrder.jsp">Subcontractor Purchase Order</a></li>
                                <li><a href="ViewSubcontractorPurchaseOrder.jsp">View Subcontractor Purchase Order</a></li>
                                <li class="divider"></li>
