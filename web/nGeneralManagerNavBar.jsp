            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Product Creation<span class="caret"></span></a> 
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/EGMIInventoryManagementSystem/GetPRIDServlet">Encode Bill Of Materials</a></li>
                                <li><a href="/EGMIInventoryManagementSystem/SearchProductServlet">Consumption Report</a></li>
                                <li><a href="/EGMIInventoryManagementSystem/ViewConsumptionReportServlet">View Consumption Report</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Procurement<span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
                                <li><a href="SupplierPurchaseOrder.jsp">Encode Supplier Purchase Order</a></li>
                                <li><a href="SubconPurchaseOrder.jsp">Encode Subcontractor Purchase Order</a></li>
                                <li><a href="Receiving.jsp">Receiving</a></li>
                                <li class="divider"></li>
                                <li><a href="CuttingReport.jsp">Create Cutting Report</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Inventory<span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
                                <li><a href="/EGMIInventoryManagementSystem/GetAccessoriesInventoryServlet">Accessories Inventory</a></li>
                                <li><a href="/EGMIInventoryManagementSystem/GetProductionInventoryServlet">Production Inventory</a></li>
                                <li><a href="/EGMIInventoryManagementSystem/GetWarehouseInventoryServlet">Warehouse Inventory</a></li>
                                <li class="divider"></li>
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Delivery<span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="/EGMIInventoryManagementSystem/GetPickingFormForDeliveryOrderServlet">Delivery Order</a></li>
                                <li><a href="DeliveryReceipt.jsp">Delivery Receipt</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Vendor<span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
                                <li><a href="/EGMIInventoryManagementSystem/ViewSuppliersAndItemServlet">Suppliers</a></li>
                                <li><a href="/EGMIInventoryManagementSystem/ViewSubcontractorAndServiceServlet">Subcontractor</a></li>
                            </ul>
                        </li>
                    </ul>
