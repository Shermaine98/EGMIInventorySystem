            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Inventory Report <span class="caret"></span></a> <ul class="dropdown-menu" role="menu">
                                <li><a href="EncodeInventoryReport.jsp">Create Inventory Report</a></li>
                                <li><a href="ViewInventoryReport.jsp">View Inventory Report</a></li>
                            </ul>
                        </li>
                    </ul>
